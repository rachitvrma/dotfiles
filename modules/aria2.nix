    ...
    programs = {
      ...
      aria2 = {
        ...
        settings = {
          ...
          async-dns = true; # was false — no known reason to serialize DNS on glibc/NixOS
          ## ── Speed limits ─────────────────────────────────────────────
          ...
          # global address, curl -6 reachable, latency parity with -4
          disable-ipv6 = false; # so keep it false
          bt-request-peer-speed-limit = "50K"; # min upload speed to request more peers from tracker/DHT
          ...
          seed-ratio = 0.0; # seeds indefinitely, no seed-time cap — correct
