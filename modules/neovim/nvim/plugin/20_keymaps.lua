...
nmap_leader("nf", function()
	require("zk").edit({ sort = { "modified" } }, { title = "Notes" })
end, "Find notes")
nmap_leader("nt", "<Cmd>ZkTags<CR>", "Browse tags")
nmap_leader("nb", "<Cmd>ZkBacklinks<CR>", "Backlinks")
nmap_leader("nl", "<Cmd>ZkLinks<CR>", "Outgoing links")
