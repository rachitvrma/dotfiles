...
(hl.curve :easy {:dampening 15.8273644
                 :mass 1
                 :stiffness 71.2633
                 :type :spring})
...
(hl.animation {:enabled true
               :leaf :windowsIn
               :speed 4.1
               :spring :easy
               :style "popin 87%"})

(hl.animation {:bezier :linear
               :enabled true
               :leaf :windowsOut
               :speed 1.49
               :style "popin 87%"})
...
(hl.animation {:bezier :easeOutQuint
               :enabled true
               :leaf :layersIn
               :speed 4
               :style :fade})
...
(hl.animation {:bezier :almostLinear
               :enabled true
               :leaf :fadeLayersIn
               :speed 1.79})
...
;; settings.permission
(hl.permission {:binary :/nix/store/naigfwbkdlnmz4apjnqrgk5mvhl4p886-grim-1.5.0/bin/grim
                :mode :allow
                :type :screencopy})

(hl.permission {:binary "/nix/store/l50glvp689h6y1flq22b3pinq9ixya47-hyprlock-0\\.9\\.5/bin/hyprlock"
                :mode :allow
                :type :screencopy})

(hl.permission {:binary :/nix/store/8wr7irfps974z88n1xw1bra3cmh81ny1-xdg-desktop-portal-hyprland-1.3.12/libexec/.xdg-desktop-portal-hyprland-wrapped
                :mode :allow
                :type :screencopy})
...
;; Noctalia Settings
(hl.window_rule {:match {:class :dev.noctalia.Noctalia}
                 :float true
                 :size [1080 920]})

;; Enable blur in noctalia shell
(hl.layer_rule {:name :noctalia
