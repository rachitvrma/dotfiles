...
** Helpful
This provides a better =*help*= interface.
...
** Colorful Mode
Highlight colors in programming mode.
...
Emacs can have =direnv= integration.
...
Source environment variables from the shell into Emacs
