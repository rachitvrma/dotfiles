    ...
    nixd = {
      ...
      settings = {
        nixd = {
          ...
          options = {
            nixos = {
              expr = '(builtins.getFlake "/home/krish/etc/nixos").nixosConfigurations.nixpavilion.options',
            },
            home_manager = {
              expr = '(builtins.getFlake "/home/krish/etc/nixos").homeConfigurations.krish.options',
            },
          },
        },
      },
...
later(function()
  ...
  require('conform').setup({
    ...
    formatters = {
      stylua = {
        -- NOTE: Don't pass --search-parent-directories here: the Nix-wrapped
...
now_if_args(function() require('guess-indent').setup({}) end)
