...
- [x] Create a home-manager module for [hyprtoolkit.conf](https://wiki.hypr.land/Hypr-Ecosystem/hyprtoolkit/).
- [ ] Version bump Gophertube in nixpkgs.
- [ ] Configure markdown_oxide for PKM-style notes.
- [ ] Fix mpd's home-manager module, see [multimedia](./modules/multimedia/module.nix)
